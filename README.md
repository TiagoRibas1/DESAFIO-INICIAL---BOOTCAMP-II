...
- Exibição de dados específicos: Nome Comum, Capital, População (formatada) e Continente (Região).
- Tratamento de erro amigável caso o país não seja encontrado ou a digitação esteja incorreta.
- Suporte para busca apertando a tecla "Enter".
